...
(1, 'asenapati@bhel.in', '7002960346', 'Aditya Sundar Senapati', 'Dholi Sonari, Titabor, Jorhat, Assam', '', '', 'Sivasagar', 5000, 0, 5000, '2021-10-06', 0),
...
--
-- Table structure for table `first_day_alumni`
--

CREATE TABLE `first_day_alumni` (
  `id` int(255) NOT NULL,
  `email` varchar(255) NOT NULL,
  `phone` varchar(255) DEFAULT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Table structure for table `second_day_alumni`
--

CREATE TABLE `second_day_alumni` (
  `id` int(255) NOT NULL,
  `email` varchar(255) NOT NULL,
  `phone` varchar(255) DEFAULT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Indexes for table `first_day_alumni`
--
ALTER TABLE `first_day_alumni`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `phone` (`phone`);
...
--
-- Indexes for table `second_day_alumni`
--
ALTER TABLE `second_day_alumni`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `phone` (`phone`);
...
--
-- AUTO_INCREMENT for table `first_day_alumni`
--
ALTER TABLE `first_day_alumni`
...
--
-- AUTO_INCREMENT for table `second_day_alumni`
--
ALTER TABLE `second_day_alumni`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT;
